...
export function ensureHydrologyOverlay(map: MapLibreMap, collections: OverlayCollections, options: OverlayOptions, onImagesReady?: () => void): boolean {
  ...
  const sourceColorExpression: ExpressionSpecification = ['match', ['get', 'fullnessSourceClass'], 'official_live', '#facc15', 'official', '#facc15', 'official_published', '#fb923c', 'satellite_altimetry', '#f87171', 'satellite_area', '#f87171', 'calculated_storage', '#22d3ee', 'not_applicable', '#64748b', '#94a3b8'] as ExpressionSpecification;
